...
public class AppCursos {
    public static void main(String[] args){
        ...
        try{
            ...
            Estudiante estudianteError = new Estudiante(null, 0, null);
        }catch (NullPointerException e){
            System.out.println("Error: No se puede crear un estudiante con nombre nulo.");
        }

        //inteto de añadir un estudiante nulo en la lista de estudiantes
        instituto.agregarEstudiante(null);
        //inteto de añadir un curso nulo en la lista de cursos
        ...
        //mostrar estudiantes
        System.out.println("Estudiante registrados:");
